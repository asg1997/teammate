...
abstract class $CityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int postcode});
}
...
class _$_City implements _City {
  const _$_City({required this.name, required this.postcode});
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, postcode);
...
abstract class _City implements City {
  const factory _City(
      {required final String name, required final int postcode}) = _$_City;
